import {getFormData, toggleEnableDisableForm} from "./modal-form.js?v=0.1.0";
import {handleFail} from "../../ajax/ajax-util/fail-handler.js?v=0.1.0";
import {closeModal} from "./modal.js?v=0.1.0";
