import {fetchAndLoadClients} from "../client/list/client-list-loading.js?v=0.3.1";
import {fetchAndLoadClientNotes} from "../client/note/client-read-note-loading.js?v=0.3.1";
import {initFilterChipEventListeners} from "../general/page-component/filter-chip/filter-chip.js?v=0.3.1";
import {loadUserActivities} from "../user/read/user-activity/activity-main.js?v=0.3.1";
