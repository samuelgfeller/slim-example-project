import {getClientProfileCardHtml} from "./client-list-profile-card.html.js?v=0.3.1";
import {
    displayClientProfileCardLoadingPlaceholder,
    removeClientCardContentPlaceholder
} from "./client-list-content-placeholder.js?v=0.3.1";
import {fetchData} from "../../general/ajax/fetch-data.js?v=0.3.1";
import {
    disableMouseWheelClickScrolling,
    openLinkOnHtmlElement
} from "../../general/event-handler/open-link-on-html-element.js?v=0.3.1";
import {
