import {getAvatarPath} from "../util/client-template-util.js?v=0.1.0";
import {escapeHtml} from "../../general/general-js/functions.js?v=0.1.0";
import {getDropdownAsHtmlOptions} from "../../general/template/template-util.js?v=0.1.0";
