import {makeClientFieldEditable} from "./update/client-update-contenteditable.js?v=0.2.1";
import {makeFieldSelectValueEditable} from "./update/client-update-dropdown.js?v=0.2.1";
import {loadAvailablePersonalInfoIconsDiv} from "./client-read-personal-info.js?v=0.2.1";
...
import {fetchAndLoadClientNotes} from "../note/client-read-note-loading.js?v=0.2.1";
import {addNewNoteTextarea} from "../note/client-read-create-note.js?v=0.2.1";
