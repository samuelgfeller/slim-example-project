import {basePath} from "../../general/general-js/config.js?v=4.0.2";
import {
...
} from "./client-read-note-event-listener-setup.js?v=4.0.2";
import {handleFail, removeValidationErrorMessages} from "../../general/ajax/ajax-util/fail-handler.js?v=4.0.2";
import {
