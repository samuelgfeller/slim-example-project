import {getNoteHtml} from "./client-read-template-note.html.js?v=0.1.0";
import {
    displayClientNoteLoadingPlaceholder,
    removeClientNoteContentPlaceholder
} from "./client-read-note-loading-placeholder.js?v=0.1.0";
import {fetchData} from "../../general/ajax/fetch-data.js?v=0.1.0";
import {initNotesEventListeners} from "./client-read-note-event-listener-setup.js?v=0.1.0";
import {initAutoResizingTextareas} from "../../general/page-component/textarea/auto-resizing-textarea.js?v=0.1.0";
import {scrollToAnchor} from "../../general/page-behaviour/scroll-to-anchor.js?v=0.1.0";
