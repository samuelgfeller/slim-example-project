import {displayClientCreateModal} from "./client-create-modal.html.js?v=0.4.1";
import {displayFlashMessage} from "../../general/page-component/flash-message/flash-message.js?v=0.4.1";
import {displayValidationErrorMessage} from "../../general/validation/form-validation.js?v=0.4.1";
import {fetchAndLoadClients} from "../list/client-list-loading.js?v=0.4.1";
