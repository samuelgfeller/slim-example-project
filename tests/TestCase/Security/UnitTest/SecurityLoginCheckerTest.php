...
namespace App\Test\TestCase\Security\UnitTest;
...
class SecurityLoginCheckerTest extends TestCase
{
     ...
     */
    #[DataProviderExternal(\App\Test\TestCase\Security\Provider\LoginRequestProvider::class, 'individualLoginThrottlingTestCases')]
