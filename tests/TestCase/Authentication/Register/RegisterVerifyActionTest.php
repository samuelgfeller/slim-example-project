...
namespace App\Test\TestCase\Authentication\Register;

use App\Module\Authentication\Data\UserVerificationData;
use App\Module\User\Enum\UserStatus;
use App\Test\Fixture\UserFixture;
use App\Test\TestCase\Authentication\Provider;
...
class RegisterVerifyActionTest extends TestCase
{
     ...
     */
    #[DataProviderExternal(Provider\UserVerificationProvider::class, 'userVerificationProvider')]
     ...
     * @param string $clearTextToken
     */
    #[DataProviderExternal(Provider\UserVerificationProvider::class, 'userVerificationInvalidTokenProvider')]
