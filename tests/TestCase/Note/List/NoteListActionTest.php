...
namespace App\Test\TestCase\Note\Lis;
...
use App\Test\TestCase\Note\List\NoteListProvider;
...
class NoteListActionTest extends TestCase
{
     ...
     * @return void
     */
    #[DataProviderExternal(NoteListProvider::class, 'noteListUserAttributesAndExpectedResultProvider')]
...
et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.';
        ...
        $expectedResponseArray[] = [
            ...
            'clientFullName' => null,
            // Has to match privilege from notePrivilegeDeterminer.php
     ...
     * @return void
     */
    #[DataProviderExternal(NoteListProvider::class, 'noteListWithFilterProvider')]
     ...
     * @return void
     */
    #[DataProviderExternal(NoteListProvider::class, 'invalidNoteListFilterProvider')]
