...
class ClientDeleteActionTest extends TestCase
{
     ...
     * @return void
     */
    #[DataProviderExternal(\App\Test\Provider\Client\ClientDeleteProvider::class, 'clientDeleteProvider')]
     ...
     * @return void
     */
    #[DataProviderExternal(\App\Test\Provider\Client\ClientDeleteProvider::class, 'clientUndeleteDeleteProvider')]
