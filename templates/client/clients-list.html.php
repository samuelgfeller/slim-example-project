 ...
 *     inactive: array{\App\Modules\FilterSetting\Data\FilterData[]},
 *     active: array{\App\Modules\FilterSetting\Data\FilterData[]},
 *     } client list filters
 *
 * @var $clientCreatePrivilege \App\Modules\Authorization\Enum\Privilege create or none
 */
...
<div class="filter-chip-container">
    <div id="active-client-filter-chips-div" class="active-filter-chips-div">
        ...
        foreach ($clientListFilters['active'] as $filterCategory => $filtersInCategory) {
            /** @var \App\Modules\FilterSetting\Data\FilterData $filterData */
