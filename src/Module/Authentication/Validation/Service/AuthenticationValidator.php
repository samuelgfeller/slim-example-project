...
final readonly class AuthenticationValidator
{
    public function __construct(
        private UserPasswordHashFinderRepository $userPasswordHashFinderRepository,
    ) {
    }
        ...
        $validator
            ...
            ->add('old_password', 'oldPasswordIsCorrect', [
                'rule' => function ($value, $context) use ($userId) {
                    ...
                    $passwordHash = $this->userPasswordHashFinderRepository->findPasswordHashFromUserId($userId);

                    // Check if old password is correct
                    return password_verify($value, (string)$passwordHash);
                },
