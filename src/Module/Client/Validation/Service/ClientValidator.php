...
namespace App\Module\Client\Validation\Service;
...
final readonly class ClientValidator
{
    public function __construct(
        private ClientStatusValidatorRepository $clientStatusValidatorRepository,
    ...
    public function validateClientValues(array $clientCreationValues, bool $isCreateMode = true): void
    {
        ...
        $validator
            ...
            ->add('client_status_id', 'exists', [
                'rule' => function ($value, $context) {
                    return $this->clientStatusValidatorRepository->clientStatusExists((int)$value);
                },
                'message' => __('Invalid option'),
            ])
