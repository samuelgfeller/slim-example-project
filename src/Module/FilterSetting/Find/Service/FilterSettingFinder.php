...
namespace App\Module\FilterSetting\Find\Service;

use App\Module\FilterSetting\Enum\FilterModule;
use App\Module\FilterSetting\Find\Data\FilterData;
use App\Module\FilterSetting\Find\Repository\UserFilterFinderRepository;
...
final readonly class FilterSettingFinder
{
    public function __construct(
        private UserFilterFinderRepository $userFilterFinderRepository,
    ...
    {
        return $this->userFilterFinderRepository->findFiltersFromUser(
